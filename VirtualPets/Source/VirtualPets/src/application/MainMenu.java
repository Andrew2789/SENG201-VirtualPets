...
public class MainMenu extends JPanel {
	...
	private JButton buttonNewGame, buttonCreateNewAsset, buttonHelp, buttonQuit;
	...
	public MainMenu(Font titleFont, Font buttonFont, Font boldFont, Font helpFont) {
		...
		buttonCreateNewAsset.setBounds(300, 221, 200, 60);
		...
		buttonHelp.setBounds(300, 292, 200, 60);
		add(buttonHelp);
		
		buttonQuit = new JButton("Quit");
		buttonQuit.setFont(buttonFont);
		buttonQuit.setEnabled(true);
		buttonQuit.setBounds(300, 363, 200, 60);
		add(buttonQuit);
